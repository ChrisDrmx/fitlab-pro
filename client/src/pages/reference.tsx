...
import { BioSwingReference } from "@/components/bioswing-reference";
import {
      ...
      <div className="p-4 md:p-6">
        <Tabs defaultValue="constructeurs">
          <TabsList className="mb-4 flex h-auto w-full flex-wrap justify-start gap-1">
            ...
            <TabsTrigger value="bioswing" data-testid="tab-bioswing">BioSwing</TabsTrigger>
          ...
          {/* ---------------- BIOSWING ---------------- */}
          <TabsContent value="bioswing" className="mt-0">
            <BioSwingReference />
          </TabsContent>
